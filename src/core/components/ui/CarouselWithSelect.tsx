        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {selectedOptions.map(opt => (
            <div key={opt.value} className="relative flex flex-col items-center border-2 border-primary bg-primary/10 rounded-xl p-1 shadow-lg transition-all">
              ...
              />
              <button
                className="absolute -top-2 -right-2 bg-background border border-primary rounded-full p-0.5 shadow hover:bg-primary hover:text-primary-foreground transition-colors"
            ...
            <SwiperSlide key={option.id}>
              ...
              >
                ...
                {value.includes(option.value) && (
                  <span className="absolute top-2 left-2 bg-primary text-primary-foreground rounded-full p-1 shadow-lg animate-fade-in">
